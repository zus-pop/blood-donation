...
const CreateOnsiteCheckDialog = () => {
  ...
  const participationIdsWithOnsiteCheck = new Set(
    (onsiteChecks ?? []).map((o) =>
      typeof o.participationId === "object" && o.participationId !== null
        ? o.participationId._id
        : String(o.participationId)
    )
  );
  return (
                      ...
                      >
                        ...
                        <SelectContent>
                          {(participations ?? [])
                            .filter(
                              (p) =>
                                !participationIdsWithOnsiteCheck.has(
                                  String(p._id)
                                )
                            )
                            .map((p) => {
